              ...
              <div class="col-lg-6">
                <div class="card-body p-md-5 mx-md-4">
                  ...
                  <div class="text-center">
                    <img src="public/frontend/images/logoshop.jpg" style="width: 185px;" alt="logo">
                  ...
                  <form method="post" action="{{ URL::to('/add-customer') }}">
                    ...
                    <div class="form-outline mb-4">
                      ...
                      <input type="text" id="form2Example11" class="form-control" placeholder="Name" name="customer_name" />
                    </div>
